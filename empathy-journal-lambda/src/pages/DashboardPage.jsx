    ...
    const demoJournals = [
      ...
      },
      {
        ...
        insight: {
          ...
          suggested_actions: [
            "In the next 5 minutes, do a gentle reset: drink water and stretch your shoulders for 1 minute.",
            "Write 2 sentences of self compassion about what you’re going through today.",
            "Choose one small task you can complete without rushing, then pause after.",
          ],
      ...
      },
      {
        ...
        insight: {
          ...
          suggested_actions: [
            "In the next 10 minutes, write 3 sentences about what you will do today to keep the streak gentle.",
            "Set one reminder for your next writing session and keep it small.",
            "Pick one tiny celebration ritual for showing up, like tea or a short walk.",
          ],
